...
public class CustomGenericArraylist {
    public static class CustomArrayListUserDefined<T extends Number>{
...
class RunCustomGenericArrayList{
    static void main() {
        CustomGenericArraylist.CustomArrayListUserDefined<Integer> listUserDefined=new CustomGenericArraylist.CustomArrayListUserDefined<>();
        for (int i = 1; i < 20; i++) {
